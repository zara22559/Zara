...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "neha") || (event.body.toLowerCase() == "neha apu") || (event.body.toLowerCase() == "@Neha Chowdhury ") || (event.body.toLowerCase() == "নেহা")) {
     return api.sendMessage("উনি এখন কাজে বিজি আছে কি বলবেন আমাকে বলতে পারেন..!😘",threadID);

       
   };

   if ((event.body.toLowerCase() == "tui ke") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎neha apur camsa☞", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:Neha❤️ হাই আমি মেছেন্জার ROBOT  নেহা আপু আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "sala ami neha") || (event.body.toLowerCase() == "cup sala ami neha") || (event.body.toLowerCase() == "madari")) {
     return api.sendMessage("সরি বস মাফ করে দেন আর এমন ভুল হবে না🥺🙏", threadID);
   };

   if ((event.body.toLowerCase() == "sojol") || (event.body.toLowerCase() == "সজল ")) {
     return api.sendMessage(" এটা একটা পাগলের আইডি সেটা সবাই জানে⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "arohi") || (event.body.toLowerCase() == "arohi")) {
     return api.sendMessage("ওর একটু মাথায় সমস্যা সেটা সবাই জানে..!😠🥰⛏️", threadID);
   };
  
  if ((event.body.toLowerCase() == "mim") || (event.body.toLowerCase() == "Mim")) {
     return api.sendMessage(" এটা নেহা আপুর বোনের নাম কেউ নাম ধরে ডাকবেন না..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "সাদ") || (event.body.toLowerCase() == "shad")) {
     return api.sendMessage(" এটা একবার প্রফেশনাল চোরের নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "tuly") || (event.body.toLowerCase() == "তুলি")) {
     return api.sendMessage("নেহা আপুর বেস্ট ফ্রেন্ডের নাম কেউ নাম ধরে ডাকবেন না⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "tnx") || (event.body.toLowerCase() == "ধন্যবাদ") || (event.body.toLowerCase() == "thank you") || (event.body.toLowerCase() == "thanks")) {
     return api.sendMessage("️ ধন্যবাদ না দিয়ে নেহা আপুকে একটা বয়ফ্রেন্ড খুজে দেন..!🌚⛏️🌶️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>নেহা আপু চামচা", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "i love you") || (event.body.toLowerCase() == "Love you") || (event.body.toLowerCase() == "I Love You") || (event.body.toLowerCase() == "ভালোবাসি") || (event.body.toLowerCase() == "i love you")) {
     return api.sendMessage(" নেহা পাগল পাগল পাত্তা দেয় না😪🥱", threadID);
   };
